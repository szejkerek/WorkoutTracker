...
export const GET: RequestHandler = async () => {
	...
	doneExercisesResults.forEach((doc) =>
		doneExercises.push({
			id: doc.id,
			data: doc.data()
		})
	...
	const mappedExercises = doneExercises.map(
		async (exer): Promise<DoneExercise> => {
...
export const DELETE: RequestHandler = async (event) => {
	...
	console.log(doneExercisesRef.id);
