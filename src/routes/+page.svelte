<script lang="ts">
	...
	const addCategory = async () => {
		const newCategory: APIUserCategory = {
			name: 'Łapy',
...
<div class="flex py-3 flex-grow flex-col align-middle bg-gray-300">
	...
	<button on:click={() => getUsers()} class="btn btn-primary"
		>get users</button
	>
	<button on:click={() => addCategory()} class="btn btn-primary"
		>add category</button
	>
	<button on:click={() => addProfile()} class="btn btn-primary"
		>add profile</button
	>
	<button on:click={() => removeUser()} class="btn btn-primary"
		>remove user:3</button
	>
	<button on:click={() => updateUser()} class="btn btn-primary"
		>update user:3c</button
	>
	<button on:click={() => removeUserCategory()} class="btn btn-primary"
		>remove category :3c</button
	>
	<button on:click={() => updateUserCategory()} class="btn btn-primary"
		>update category :3c</button
	>
	<button on:click={() => removeBodyProfile()} class="btn btn-primary"
		>remove body profile</button
	>
	<button on:click={() => addExercise()} class="btn btn-primary"
		>add exercise</button
	>
	<button on:click={() => updateExercise()} class="btn btn-primary"
		>update exercise</button
	>
	<button on:click={() => removeExercise()} class="btn btn-primary"
		>remove exercise</button
	>
	<button on:click={() => addTrainingPlan()} class="btn btn-primary"
		>add training plan</button
	>
	<button on:click={() => updateTrainingPlan()} class="btn btn-primary"
		>update training plan</button
	>
	<button on:click={() => removeTrainingPlan()} class="btn btn-primary"
		>remove training plan</button
	>
	<button on:click={() => addDoneExercise()} class="btn btn-primary"
		>add Done Exercise</button
	>
	<button on:click={() => updateDoneExercise()} class="btn btn-primary"
		>update Done Exercise</button
	>
	<button on:click={() => removeDoneExercise()} class="btn btn-primary"
		>remove Done Exercise</button
	>
	<button on:click={() => addPost()} class="btn btn-primary">add post</button>
	<button on:click={() => removePost()} class="btn btn-primary"
		>remove post</button
	>
